...
from cloud_command.agent.command_model import CommandResultModel, CommandModel
...
async def run_command(name: str, command_model: CommandModel) -> CommandResultModel:
    ...
    stdout, stderr, exit_code = await asyncio.to_thread(agent.run_command, command_model.command, sudo=command_model.sudo)
